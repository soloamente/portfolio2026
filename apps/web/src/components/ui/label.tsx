...
function Label({ className, ...props }: React.ComponentProps<"label">) {
	return (
		// Label receives htmlFor via ...props from parent; association happens at usage site
		// biome-ignore lint/a11y/noLabelWithoutControl: polymorphic component—parent passes htmlFor
		<label
			className={cn(
